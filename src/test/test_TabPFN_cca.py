...
def test_TabPFN_cca(x_te, y_te_tensor, labels_test_emb, cca, 
    ...
    X_train, labels_tr_tr = cca.transform(x_train, labels_train_emb)
    X_test, labels_te_tr = cca.transform(x_te, labels_test_emb)
