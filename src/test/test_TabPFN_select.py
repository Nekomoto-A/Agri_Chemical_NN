...
def test_TabPFN_select(x_te, y_te_tensor, labels_test, 
    ...
    for reg in reg_list:
        ...
        # 回帰タスクの処理
            ...
            if reg in scalers:
                ...
                if is_log1p_transformer(scaler):
                    train_out = models[reg].predict(x_train, labels_train)
        ...
        result_detail = models[reg].predict_with_uncertainty(x_te, labels_test)
