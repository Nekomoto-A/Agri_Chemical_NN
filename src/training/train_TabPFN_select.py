...
def training_TabPFN_select(x_tr,x_val,y_tr,y_val,models, labels_train,labels_val, reg_list, scalers, output_dir, 
    ...
    for reg in reg_list:
        ...
        result_detail = models[reg].predict_with_uncertainty(x_tr, labels_train)
