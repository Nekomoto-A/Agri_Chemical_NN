...
def training_TabPFN_cca(x_tr,x_val,y_tr,y_val,models, labels_train_emb, labels_val_emb, reg_list, scalers, output_dir, 
    ...
    for reg in reg_list:
        ...
        X_train,labels_tr = cca.fit_transform(x_tr, labels_train_emb)
    ...
    return models, selected_indices, cca
